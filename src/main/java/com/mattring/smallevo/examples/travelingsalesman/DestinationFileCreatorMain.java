...
/**
 * Creates the tsp_destinations.txt for a 1000 x 1000 grid with 20 randomly chosen destinations.
 * args[0] may be used to override the default of 20 destinations.
 * 
 * @author mring
 */
class DestinationFileCreatorMain {

    public static final String TSP_FILE = "tsp_destinations.txt";
    public static final double GRID_SIZE = 1000.0d;
    private static final int DEFAULT_NUM_DESTINATIONS = 20;
